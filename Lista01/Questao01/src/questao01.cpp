...
bool Questao01::adicionaEmpresa(Empresa *nova)
{
    this->empresas.push_back(nova);
    return true;
}
bool Questao01::removeEmpresa(string nome)
{
    return true;
}
void Questao01::aumento() {}
void Questao01::addEmpresa() {}
void Questao01::remEmpresa() {}
void Questao01::listarFuncionariosEmExperiencia()
{
}
void Questao01::listarMediaDeFuncionariosPorEmpresa() {}
void Questao01::testar()
{
